...
def parse_args():
    ...
    parser.add_argument('--model_dir', type=str, default='./training_model/LHP_Rain')
    parser.add_argument('--device',   type=str,default='cuda:0')

    parser.add_argument('--ckp_name' ,type=str ,default='best')
    parser.add_argument('--result_dir', type=str,default='./results/LHP_Rain')
...
def run_test():
    ...
    for i, batch in enumerate(dataloader):
        ...
        logfile = open('./results/' + 'test_LHP_Rain' + '.txt', 'a+')
        logfile.write(
            'num   = ' + str(i + 1)    + '\t'
